...
shareExpApp.controller('IndexController', function($scope, $state, $location, cfpLoadingBar, CookieService, SessionService, AuthenticationService, FlashService) {
        ...
        userVerify.then(
                function(response) {
                    ...
                    if($scope.user.status === 'I'){
                    	FlashService.show('Please provide activation Code to Login', 'alert-warning');
                ...
                function(response) {
                	alert(response);
                    FlashService.show('Status Code: ' + response.status + response, 'alert-danger');
                    cfpLoadingBar.complete();
                }
        );
    };
...
shareExpApp.run(
        function($rootScope, $location, AuthenticationService) {
        	...
        	var routesThatRequireAuth = ['/home', '/home/signup', "/home/login", '/home/activation'];
